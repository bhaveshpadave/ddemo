...
/**
 * @file
 * Creates config form for RSVP list block
 */
  ...
  */
  ...
  Class RSVPSettingsForm extends ConfigFormBase {
    ...
    public function buildForm(array $form, FormStateInterface $form_state,){
        ...
        $form['rsvplist_types'] = [
            '#type' => 'checkboxes',
            '#title' => $this->t('The content types to enble RSVP for'),
            '#default_value' => $config->get('allowed_types'),
            '#options'=> $types,
            '#description' => $this->t('On specified node type, an RSVP option 
            will be avaialble and can be enabled while the node is being edited'),
        ];
